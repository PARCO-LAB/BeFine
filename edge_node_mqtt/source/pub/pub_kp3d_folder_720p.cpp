 ...
 * 
 * USAGE:
 * ./pub_kp3d_folder_720p -fconf <conf-fp> 
...
void print_help()
{
    std::cout << "USAGE: "                                     << std::endl
        << " ./pub_kp3d_folder_720p -fconf <conf-fp> "         << std::endl
...
int main(int argc, char* argv[])
{
    ...
    maeve::Folder device({
        maeve::RgbSensor(720, 1280, 15), 
        maeve::DepthSensor(720, 1280, 15)},
