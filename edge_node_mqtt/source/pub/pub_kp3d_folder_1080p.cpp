/**
 * @file pub_kp3d_folder_1080p.cpp
 ...
 * 
 * USAGE:
 * ./pub_kp3d_folder_1080p -fconf <conf-fp> 
...
void print_help()
{
    std::cout << "USAGE: "                                     << std::endl
        << " ./pub_kp3d_folder_1080p -fconf <conf-fp> "        << std::endl
...
int main(int argc, char* argv[])
{
    ...
    maeve::Folder device({
        maeve::RgbSensor(1080, 1920, 15), 
        maeve::DepthSensor(1080, 1920, 15)},
