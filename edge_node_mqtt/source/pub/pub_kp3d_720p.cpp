...
void print_help()
{
    std::cout << "USAGE: "                                     << std::endl
        << " ./pub_kp3d_720p -fconf <conf-fp> "                   << std::endl
...
int main(int argc, char* argv[])
{
    ...
    device_setting.resolution = sl::RESOLUTION::HD720;
    maeve::Camera device;
    ...
    {
        device = maeve::Camera({
            maeve::RgbSensor(720, 1280, 60), 
            maeve::DepthSensor(720, 1280, 60)},
            device_setting);
    }
