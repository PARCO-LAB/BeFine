...
void print_help()
{
    std::cout << "USAGE: "                                        << std::endl
        << " ./pub_kp3d_loop -fconf <conf-fp> "                   << std::endl
...
int main(int argc, char* argv[])
{
    ...
    {
        std::cout << "Error: missing path of file camera stream." << std::endl;
        print_help();
        return 1;
    }
